// pages/Register.jsx - Register (Sign Up) Component
...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic frontend verification check
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg border border-slate-100 transition-all duration-300 hover:shadow-xl">
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          <div className="space-y-4 rounded-md shadow-sm">
            <div>
              <label htmlFor="name-input" className="block text-sm font-semibold text-slate-700 mb-1">
                Full Name
              </label>
              <input
                id="name-input"
